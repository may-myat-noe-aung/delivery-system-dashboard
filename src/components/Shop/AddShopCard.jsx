...
// const AddShopCard = ({ shops, onDetail }) => {
...
//                   {/* <div className="flex items-center gap-2 bg-white py-1 px-3 rounded-md shadow-sm">
//                     <Edit className="w-4 h-4 text-[#B476FF]" />
//                     <div className="w-[1px] h-5 bg-[#B476FF]" />
//                     <Trash2 className="w-4 h-4 text-[#B476FF]" />
//                   </div> */}
//                 </div>
...
//                     />
//                   ) : (
//                     <div className="size-24 flex items-center justify-center border-2 border-dashed rounded text-white text-xs">
//                       No Image
//                     </div>
//                   )}
...
//                   className="bg-white text-[#B476FF] px-3 py-2 rounded-md text-sm font-semibold flex items-center justify-center gap-2"
//                 >
