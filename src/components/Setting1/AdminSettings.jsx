...
return (
  <div className="bg-gray-900 text-gray-100 p-4 md:h-[100vh] mx-auto overflow-hidden">
    {/* Tabs */}
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="flex flex-col items-center text-center">
            {account ? (
              <>
                ...
                />
                <p className="font-semibold text-lg">{account.name || "Admin"}</p>
                <p className="text-sm text-gray-400 bg-gray-700 px-3 py-1 rounded-full mt-1">
                  {account.role || "owner"}
                </p>
              </>
            ) : (
      ...
      {/* RIGHT */}
      <div className="col-span-1 md:col-span-3 bg-gray-800 rounded-2xl border border-gray-700 p-6 shadow-sm">
        {activeTab === "overview" && <OverviewTab account={account} />}
        {activeTab === "edit" && <EditAccountTab account={account} setAccount={setAccount} />}
        {activeTab === "security" && <SecurityTab />}
        {activeTab === "create" && <CreateAccount />}
