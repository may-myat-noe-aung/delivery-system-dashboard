...
//     const fetchAdmin = () => {
//       fetch(`http://38.60.244.108:3000/admin/${adminId}`)
//         .then((res) => res.json())
//         .then((data) => {
...
//     fetchAdmin();
//     const interval = setInterval(fetchAdmin, 5000); // Changed to 5s

//     return () => clearInterval(interval);
//   }, [adminId]);

//   return (
//     <div className="bg-white text-gray-900 p-4 md:h-[100vh] mx-auto max-w-7xl overflow-hidden">
//       {/* Horizontal Tabs */}
...
//                   : "text-gray-600 hover:bg-[#B476FF]/20 hover:text-[#B476FF]"
//               }`}
//             >
//               {item.icon}
//               {item.label}
...
//             <h3 className="font-bold text-lg mb-4 text-center text-[#B476FF]">Profile</h3>
...
//                     src={
//                       account.photo
//                         ? `http://38.60.244.108:3000/admin-uploads/A002.jpg`
...
//           {/* Quick Actions */}
//           <div className="bg-white rounded-2xl border border-gray-300 p-6 shadow-sm">
//             <h3 className="font-bold text-lg mb-4 text-[#B476FF]">Quick Actions</h3>
//             <div className="space-y-2">
//               {quickActions.map((action, index) => (
//                 <button
//                   key={index}
//                   onClick={() => action.action && setActiveTab(action.action)}
//                   className="flex items-center gap-3 w-full p-3 rounded-lg hover:bg-[#B476FF]/20 hover:text-[#B476FF] transition-colors text-gray-700 text-sm"
//                 >
//                   {action.icon}
...
//         {/* Right Column */}
//         <div className="col-span-1 md:col-span-3 bg-white rounded-2xl border border-gray-300 p-6 shadow-sm">
...
export default function AdminSettings() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 md:h-[100vh] mx-auto max-w-7xl overflow-hidden">
      {/* Tabs */}
