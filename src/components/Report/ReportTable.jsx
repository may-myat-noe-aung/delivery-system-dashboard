...
//                   <td className="py-4 text-purple-400">{order.type}</td>
...
useEffect(() => {
  ...
  return (
    <div className="">
      ...
      {/* ===== Header: search, date filter, export ===== */}
      <div className="mb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-8">
      ...
      {loading ? (
        ...
        <div className="text-center text-slate-400 py-10">“No reports available for this shop.”</div>
      ) : (
        <div className="overflow-x-auto bg-[#1a2030]/80 backdrop-blur-xl border border-slate-700 rounded-3xl shadow-2xl p-6">
          <table className="w-full text-sm">
            <thead className="text-slate-400 border-b border-slate-700">
