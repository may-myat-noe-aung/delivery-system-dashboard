...
export default function ReportDeliveryOrder() {
  return (
    <div className="p-6 grid grid-cols-1 lg:grid-cols-4 gap-6 bg-gray-900 text-gray-100">
      {/* Reported Cases */}
      <div className="bg-gray-800 text-gray-100 p-4 rounded-2xl shadow border border-gray-700">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold">Reported Cases</h2>
          <div className="text-sm text-white flex items-center justify-center gap-2 bg-[#a855f7] px-3 py-1 rounded-lg">
            This Weekly
            <ChevronDown className="w-4 h-4" />
          </div>
        </div>
      ...
      {/* Delivery Card */}
      <div className="bg-gray-800 text-gray-100 rounded-2xl shadow-md p-4 border border-gray-700">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center space-x-2">
            <img
              src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png"
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="relative flex items-center w-64">
            ...
            <input
              type="text"
              placeholder="Search"
              className="pl-9 pr-3 py-2 text-sm rounded-full w-full bg-gray-700 text-gray-100 border border-gray-600 focus:outline-none"
            />
          </div>
        ...
        {/* Progress */}
        <div className="relative mt-6">
          <div className="flex justify-between items-center text-sm mb-2 px-1 text-gray-300">
            <span>Starting point</span>
            <span>Customer</span>
          </div>

          <div className="relative h-2 bg-purple-900 rounded-full">
            <div className="absolute h-2 bg-purple-500 rounded-full" style={{ width: "45%" }}></div>
            <div className="absolute left-[45%] -translate-x-1/2 -top-5 w-8 h-8 bg-gray-800 border-4 border-purple-400 rounded-full flex items-center justify-center">
              <Truck size={16} className="text-purple-400" />
            </div>
          </div>

          <div className="flex justify-between mt-2 mb-4 px-1 text-gray-300">
            <span className="text-sm">45% completed</span>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between gap-2 mt-4 text-sm">
          <div>
            ...
            <span className="text-purple-400 font-semibold">1:30 mins</span>
          </div>
          <div>
            <span className="text-gray-400">Estimated Arrival: </span>
            <span className="text-purple-400 font-semibold">2:30 mins</span>
          </div>
        </div>
      </div>

      {/* Order Progress */}
      <div className="bg-gray-800 text-gray-100 p-5 rounded-2xl shadow col-span-2 border border-gray-700">
