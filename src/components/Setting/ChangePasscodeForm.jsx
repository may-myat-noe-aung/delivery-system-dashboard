    ...
    <div className="w-full">
      ...
      <div className="space-y-5 w-full">
        ...
        <div className="w-full relative" ref={dropdownRef}>
          ...
          <div
            className="w-full rounded-lg bg-neutral-800 border focus:border-[#B476FF] border-neutral-700 px-3 py-2 text-sm text-neutral-200 cursor-pointer"
          ...
          {dropdownOpen && (
            <ul className="absolute z-50 w-full max-h-48 overflow-y-auto bg-neutral-900 border border-neutral-700 rounded-lg mt-1 scrollbar-none">
              {emails.map((admin, index) => (
                <li
                  key={admin.id}
                  className="px-3 py-2 cursor-pointer hover:bg-[#B476FF] hover:text-black"
        ...
        <div className="w-full">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm focus:border-[#B476FF]"
            />
            <span
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4">
          ...
          <button
            ...
            disabled={loading}
            className="rounded-lg bg-[#B476FF] text-black px-5 py-2 font-medium text-sm"
          >
