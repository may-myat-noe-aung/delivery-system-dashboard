    ...
    <div className="w-full">
      ...
      <div className="space-y-5 w-full">
        ...
        <div className="w-full relative" ref={dropdownRef}>
          ...
          <div
            className="w-full rounded-lg bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm cursor-pointer focus:outline-none focus:border-[#B476FF]"
        ...
        <div className="w-full">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm text-neutral-200 placeholder-neutral-500 focus:outline-none focus:border-[#B476FF]"
            />
            <span
