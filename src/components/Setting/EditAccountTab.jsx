...
const token = localStorage.getItem("token");
  ...
  formData,
  {
    headers: {
      ...
      console.error(err);
      // Try to use API error message if exists
    ...
    <div>
      <div className="flex justify-between">
        ...
        <div className="mb-6 w-[300px] relative" ref={dropdownRef}>
          ...
          <div
            className="w-full rounded-lg bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm text-neutral-200 cursor-pointer focus:outline-none focus:border-[#B476FF]"
          ...
          {dropdownOpen && (
            <ul className="absolute z-50 w-full max-h-48 overflow-y-auto bg-neutral-900 border border-neutral-700 rounded-lg mt-1 scrollbar-none">
              {accounts.map((a, index) => (
                <li
                  key={a.id}
                  className={`px-3 py-2 cursor-pointer text-white hover:bg-purple-400 hover:text-black`}
                  onClick={() => {
                  ...
                  <img
                    src={
                      account.photo instanceof File
                        ...
                        : `https://api.pwezayshops.com/admin-uploads/${account.photo}`
                    }
                    alt={account.name}
          ...
          <div className="flex-1 grid grid-cols-2 gap-6">
            ...
            <div className="col-span-2 flex justify-end gap-3 pt-4">
              ...
              <button
                ...
                disabled={saving}
                className="rounded-lg bg-[#B476FF] text-black px-5 py-2 hover:bg-[#B476FF] transition-colors font-medium text-sm"
              >
          ...
          <div className="bg-neutral-900 border border-neutral-700 rounded-xl p-6 w-80 relative">
            ...
            <div className="flex justify-between">
              ...
              <button
                ...
                className="bg-[#B476FF] hover:bg-[#B476FF]-500 text-black px-3 py-2 rounded-md text-sm"
              >
                Confirm
              </button>
            </div>
