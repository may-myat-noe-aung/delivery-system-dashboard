  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://api.pwezayshops.com/admin/${deleteTarget.id}`,
        {
          method: "DELETE",
          headers: {
            // Authorization: `Bearer ${token}`, 
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-2">
          <div className="relative w-full md:w-64">
            ...
            <input
              ...
              className="w-full md:w-64 rounded-2xl bg-neutral-900 border border-neutral-700 pl-8 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#B476FF]"
              type="text"
            />
          </div>
          <button
                ...
                >
                  ...
                  <td className="py-2 px-3">
                    {a.photo ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-[#B476FF] text-black font-semibold flex items-center justify-center mx-auto">
                        {a.name
                          ? a.name
                              .split(" ")
                              .map((n) => n[0])
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-neutral-900 border border-neutral-700 rounded-xl p-6 w-80 relative">
            ...
            <input
              ...
              className="w-full rounded-lg bg-neutral-800 border border-neutral-700 px-3 py-2 text-sm mb-4 focus:outline-none focus:ring-1 focus:ring-[#B476FF] focus:border-[#B476FF] transition"
              autoFocus
              onKeyDown={(e) => {
